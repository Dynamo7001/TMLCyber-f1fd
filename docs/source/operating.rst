...
.. important::
   https://github.com/Dynamo7001/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41373  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Dynamo7001'  \-\-env DOCKERUSERNAME='hooluwole'  \-\-env MQTTUSERNAME='hammed'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 58887:58887 -p 37521:37521 -p 51809:51809 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=TMLCyber-f1fd \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-TMLCyber-f1fd \-\-env GITUSERNAME=Dynamo7001  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi \-\-env SOLUTIONEXTERNALPORT=58887  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=37521  \-\-env SOLUTIONVIPERVIZPORT=51809 \-\-env DOCKERUSERNAME='hooluwole' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=41373 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hammed' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole/TMLCyber-f1fd-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=51809
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=58887
...
It can be accessed by entering: http://localhost:37521
...
.. important::
   http://localhost:51809/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51809/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:51809/<html file>
...
.. important::
   https://github.com/Dynamo7001/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/TMLCyber-f1fd
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=58887, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=34813, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37669, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45101, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34899, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41879, HPDEHOST=127.0.1.1, HPDEPORT=39445, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35319

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-403-TMLCyber-f1fd,solution_preprocessing_ai_mqtt_dag-TMLCyber-f1fd, python-preprocess-1151-TMLCyber-f1fd,solution_preprocessing_ai_mqtt_dag-TMLCyber-f1fd, python-ai-7910-TMLCyber-f1fd,solution_preprocessing_ai_mqtt_dag-TMLCyber-f1fd, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
